...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<Search_Replace> mDatas;
    ...
    public ItemHeaderDecoration(Context context, List<Search_Replace> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<Search_Replace> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    private void drawHeader(RecyclerView parent, int pos, Canvas canvas) {
        View topTitleView = mInflater.inflate(R.layout.search_right_recycler_title, parent, false);
        TextView tvTitle = (TextView) topTitleView.findViewById(R.id.search_right_title_letf_Title);
        tvTitle.setText(mDatas.get(pos).opt_name);
        //绘制title开始
